...
export const ACCENTS: Record<Accent, { bar: string; chip: string; name: string }> = {
  forest: { bar: "bg-forest", chip: "bg-forest/10 text-forest", name: "Forest" },
  gold: { bar: "bg-gold", chip: "bg-gold/25 text-forest", name: "Gold" },
  clay: { bar: "bg-clay", chip: "bg-clay/10 text-clay", name: "Clay" },
